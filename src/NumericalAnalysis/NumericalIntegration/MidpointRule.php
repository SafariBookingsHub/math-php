<?php
    ...
    class MidpointRule extends NumericalIntegration {
        ...
        public static function approximateEndpointsTwoInteriorPointsNotSorted()
        {
        }

        public static function approximateEndpointsTwoInteriorPoints()
        {
        }

        public static function approximateEndpointsOneInteriorPoint()
        {
        }

        public static function approximateEndpoints()
        {
        }
    }
