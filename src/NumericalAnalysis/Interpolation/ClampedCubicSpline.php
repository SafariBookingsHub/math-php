<?php
    ...
    class ClampedCubicSpline extends Interpolation {
         ...
         *
         */
        public static function getSplinePoints(
            callable|array $source,
            array $args
        ): array {
            ...
            return self::functionToSplinePoints($function, $derivative, $start,
                $end, $n);
        }
         ...
         * @return array<array{int|float, int|float, int|float}>
         */
        protected static function functionToSplinePoints(
            callable $function,
            callable $derivative,
            float $start,
            float $end,
         ...
         */
        public static function validateSpline(
            array $points,
            int $degree = 2
        ): void {
