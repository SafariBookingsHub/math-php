<?php
    ...
    class Outlier {
         ...
         */
        public static function grubbsStatistic(
            array $data,
            string $typeOfTest = self::TWO_SIDED
        ): float {
            $μ = Average::mean($data);
         ...
         */
        public static function grubbsCriticalValue(
            float $𝛼,
            int $n,
            string $typeOfTest
        ): float {
         ...
         * @throws Exception\BadParameterException
         */
        private static function validateGrubbsCriticalValueTestType(
            string $typeOfTest
        ): void {
