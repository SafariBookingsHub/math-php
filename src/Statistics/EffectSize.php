<?php
    ...
    class EffectSize {
         ...
         * @return float
         */
        public static function omegaSquared(
            float $SSt,
            int $dft,
            float $SST,
            float $MSE
         ...
         * @return float
         */
        public static function cohensF(float $measure_of_variance_explained
        ): float {
            return $measure_of_variance_explained / (1
                    - $measure_of_variance_explained);
        }
         ...
         * @return float
         */
        public static function cohensD(
            float $μ₁,
            float $μ₂,
            float $s₁,
            float $s₂
         ...
         * @return float
         */
        public static function hedgesG(
            float $μ₁,
            float $μ₂,
            float $s₁,
            float $s₂,
         ...
         * @return float
         */
        public static function glassDelta(
            float $μ₁,
            float $μ₂,
            float $s₂
        ): float {
        ...
        public static function cohensQExceptionROutOfBounds()
        {
        }
    }
