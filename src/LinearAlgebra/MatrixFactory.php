<?php
    ...
    class MatrixFactory {
         ...
         * @throws \MathPHP\Exception\MatrixException if the Vectors are not all the same length
         */
        public static function createFromVectors(
            array $A,
            ?float $ε = NULL
        ): NumericMatrix {
