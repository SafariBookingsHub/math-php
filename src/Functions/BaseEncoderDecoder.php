<?php
    ...
    class BaseEncoderDecoder {
        ...
        public static function invalidCharInStringException()
        {
        }

        public static function invalidBaseException()
        {
        }
        ...
        public static function invalidToBaseException()
        {
        }

        public static function createArbitrary()
        {
        }
    }
