<?php
    ...
    class MtCars {
         ...
         * @return int[]
         */
        public static function getCyl(): array
        {
         ...
         * @return int[]|float[]
         */
        public static function getDisp(): array
        {
         ...
         * @return int[]
         */
        public static function getHp(): array
        {
         ...
         * @return float[]
         */
        public static function getDrat(): array
        {
         ...
         * @return float[]
         */
        public static function getWt(): array
        {
         ...
         * @return float[]
         */
        public static function getQsec(): array
        {
         ...
         * @return int[]
         */
        public static function getVs(): array
        {
         ...
         * @return int[]
         */
        public static function getAm(): array
        {
         ...
         * @return int[]
         */
        public static function getGear(): array
        {
         ...
         * @return int[]
         */
        public static function getCarb(): array
        {
