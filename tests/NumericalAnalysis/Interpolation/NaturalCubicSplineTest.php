<?php
    ...
    class NaturalCubicSplineTest extends TestCase {
        /**
         * @return array (x, expected)
         */
        public static function dataProviderForPiecewiseForPolynomialAgrees(
        ): array
        {
            return [
                [0, 0],    // p(0) = 0
        ...
        public function testSolveZeroError($x)
        {
            ...
            // Then
            $this->assertEqualsWithDelta($expected, $evaluated,
                $tol + $roundoff);
        }
