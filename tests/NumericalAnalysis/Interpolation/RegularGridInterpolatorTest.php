<?php
    ...
    class RegularGridInterpolatorTest extends TestCase {
        /**
         ...
         */
        public static function dataProviderForRegularGridAgrees(): array
        {
            return [
                // test_linear_xi3d
                [[0.1, 0.1, 1., .9], 1001.1],
         ...
         * @return array (x, expected)
         */
        public static function dataProviderForRegularGridNearestAgrees(): array
        {
            return [
                [[0.1, 0.1, .9, .9], 1100],
                [[0.1, 0.1, 0.1, 0.1], 0.],
         ...
         */
        public static function dataProviderForSimilarValues(): array
        {
            return [
                [[1, 1, 1], 4.],
                [[1, 1, 2], 3.],
        ...
        {
            // Given
            [$points, $values] = RegularGridInterpolatorTest::getSample4d();
         ...
         */
        private static function getSample4d(): array
        {
            $points = [
                [0.0, 0.5, 1.0],
                [0.0, 0.5, 1.0],
        ...
        public function testRegularGridNearestAgrees(array $point, $expected)
        {
            ...
            // And
            $p = new RegularGridInterpolator($points, $values,
                RegularGridInterpolator::METHOD_NEAREST);
