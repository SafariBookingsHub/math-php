<?php
    ...
    class ANOVATest extends TestCase {
        /**
         * @return array [sample1, sample2, sample3, expectedAnova]
         */
        public static function dataProviderForOneWayWithThreeSamples(): array
        {
            return [
                [
                    [1, 2, 3],
         ...
         */
        public static function dataProviderForOneWayWithFourSamples(): array
        {
            return [
                [
                    [
         ...
         */
        public static function dataProviderForOneWayAxiomsThreeSamples(): array
        {
            return [
                [
                    [1, 2, 3],
         ...
         */
        public static function dataProviderForOneWayAxiomsFiveSamples(): array
        {
            return [
                [
                    [1, 2, 3],
         ...
         */
        public static function dataProviderForTwoWayTwoAs(): array
        {
            return [
                [
                    // Factor A₁
         ...
         */
        public static function dataProviderForTwoWayThreeAs(): array
        {
            return [
         ...
         */
        public function testOneWayWithThreeSamples(
            array $sample1,
            array $sample2,
            array $sample3,
            array $expected
         ...
         * @param array $expected
         */
        public function testOneWayWithFourSamples(
            array $sample1,
            array $sample2,
            array $sample3,
            array $sample4,
         ...
         * @param array $sample3
         */
        public function testOneWayAxiomsThreeSamples(
            array $sample1,
            array $sample2,
            array $sample3
        ) {
         ...
         * @param array $sample5
         */
        public function testOneWayAxiomsFiveSamples(
            array $sample1,
            array $sample2,
            array $sample3,
            array $sample4,
         ...
         * @param array $expected
         */
        public function testTwoWayThreeAs(
            array $A₁,
            array $A₂,
            array $A₃,
            array $expected
