<?php
    ...
    class DivergenceTest extends TestCase {
         ...
         */
        public static function dataProviderForKullbackLeibler(): array
        {
            return [
                [
                    [0.5, 0.5],
         ...
         * @return array [p, q, distance]
         */
        public static function dataProviderForJensenShannonDivergence(): array
        {
            return [
                [
                    [0.4, 0.6],
         ...
         * @param float $expected
         */
        public function testJensenShannonDivergence(
            array $p,
            array $q,
            float $expected
        ) {
