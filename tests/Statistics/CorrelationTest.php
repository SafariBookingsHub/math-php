<?php
    ...
    class CorrelationTest extends TestCase {
         ...
         */
        public static function dataProviderForPopulationCovariance(): array
        {
            return [
         ...
         */
        public static function dataProviderForWeightedCovariance(): array
        {
            return [
                ...
                [
                    [1.4, 1.9, 2.6, 0.3, 0.3, 0.8, 1, 2.5, 2.9, 0.9],
                    [2.6, 3, 1.4, 1.5, 2.8, 1.9, 1.9, 0.6, 2.0, 2.1],
                    [
                        0.87,
                        0.68,
                        0.69,
         ...
         */
        public static function dataProviderForWeightedCovarianceException(
        ): array
        {
            return [
                [
         ...
         * @return array [X, Y, covariance]
         */
        public static function dataProviderForSampleCovariance(): array
        {
            return [
         ...
         */
        public static function dataProviderForPopulationCorrelationCoefficient(
        ): array
        {
            return [
                [
         ...
         */
        public static function dataProviderForWeightedCorrelationCoefficient(
        ): array
        {
            return [
                [
         ...
         * @return array [x, y, ppc]
         */
        public static function dataProviderForSampleCorrelationCoefficient(
        ): array
        {
            return [
         ...
         * @return array [X, Y, τ]
         */
        public static function dataProviderForKendallsTau(): array
        {
            return [
                // No ties for tau-a
                [
         ...
         * @return array [X, Y, ρ]
         */
        public static function dataProviderForSpearmansRho(): array
        {
            return [
                [
         ...
         */
        public static function dataProviderForEllipse(): array
        {
            return [
                [
                    [
         ...
         * @throws       \Exception
         */
        public function testCovariancePopulation(
            array $X,
            array $Y,
            float $expected
        ) {
         ...
         * @throws       \Exception
         */
        public function testPopulationCovariance(
            array $X,
            array $Y,
            float $expected
        ) {
         ...
         * @throws       \Exception
         */
        public function testWeightedCovariance(
            array $X,
            array $Y,
            array $w,
            float $expected
         ...
         */
        public function testWeightedCovarianceException(
            array $X,
            array $Y,
            array $w
        ) {
         ...
         * @throws       \Exception
         */
        public function testCovarianceSample(
            array $X,
            array $Y,
            float $expected
        ) {
         ...
         * @throws       \Exception
         */
        public function testSampleCovariance(
            array $X,
            array $Y,
            float $expected
        ) {
         ...
         * @throws       \Exception
         */
        public function testPopulationCorrelationCoefficient(
            array $x,
            array $y,
            float $expected
        ) {
         ...
         * @throws       \Exception
         */
        public function testWeightedCorrelationCoefficient(
            array $x,
            array $y,
            array $w,
            float $expected
         ...
         * @throws       \Exception
         */
        public function testSampleCorrelationCoefficient(
            array $x,
            array $y,
            float $expected
        ) {
         ...
         * @throws       \Exception
         */
        public function testCoefficientOfDetermination(
            array $X,
            array $Y,
            float $expected
        ) {
        ...
        {
            // When
            $calc = Correlation::confidenceEllipse(array_column($data, 0),
                array_column($data, 1), $sd);
