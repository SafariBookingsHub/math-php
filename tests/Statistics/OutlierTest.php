<?php
    ...
    class OutlierTest extends TestCase {
        /**
         * Calculated with R outliers grubbs.test(z, type=10, two.sided=TRUE)
         *
         * @return array
         */
        public static function dataProviderForGrubbsStatisticTwoSided(): array
        {
            return [
                [
                    [
         ...
         */
        public static function dataProviderForCriticalValueOneSided(): array
        {
            return [
                // 𝛼 = 0.05
                [0.05, 3, 1.1531],
         ...
         */
        public static function dataProviderForCriticalValueTwoSided(): array
        {
            return [
                // 𝛼 = 0.05
                [0.05, 3, 1.1543],
         ...
         * @throws       \Exception
         */
        public function testGrubbsStatisticTwoSided(
            array $data,
            float $expectedG
        ) {
            // When
         ...
         * @throws       \Exception
         */
        public function testGrubbsStatisticOneSidedLower(
            array $data,
            float $expectedG
        ) {
            // When
         ...
         * @throws       \Exception
         */
        public function testGrubbsStatisticOneSidedUpper(
            array $data,
            float $expectedG
        ) {
            // When
         ...
         */
        public function testCriticalGrubsOneSided(
            float $𝛼,
            int $n,
            float $expectedCriticalValue
        ) {
            // Given
            ...
            // Then
            $this->assertEqualsWithDelta($expectedCriticalValue, $criticalValue,
                0.001);
        }
         ...
         * @throws       Exception\BadParameterException
         */
        public function testCriticalGrubsTwoSided(
            float $𝛼,
            int $n,
            float $expectedCriticalValue
        ) {
