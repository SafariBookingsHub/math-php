<?php
    ...
    class CenterFalseScaleFalseTest extends TestCase {
        /** @var PCA */
        ...
        public function testScores()
        {
            ...
            // When
            $scores = self::$pca->getScores(MatrixFactory::create([
                [
                    1,
                    2,
                    3,
            ...
            // Then
            $this->assertEqualsWithDelta($sign_adjusted->getMatrix(),
                $scores->getMatrix(), .00001);
        }
