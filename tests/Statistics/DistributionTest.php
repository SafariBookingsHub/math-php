<?php
    ...
    class DistributionTest extends TestCase {
         ...
         */
        public static function dataProviderForFrequency(): array
        {
            return [
                [
                    ['A', 'A', 'B', 'B', 'B', 'B', 'C', 'C', 'D', 'F'],
         ...
         * @return array [values, frequencies]
         */
        public static function dataProviderForRelativeFrequency(): array
        {
            return [
                [
                    ['A', 'A', 'B', 'B', 'B', 'B', 'C', 'C', 'D', 'F'],
         ...
         * @return array [values, frequencies]
         */
        public static function dataProviderForCumulativeFrequency(): array
        {
            return [
                [
                    ['A', 'A', 'B', 'B', 'B', 'B', 'C', 'C', 'D', 'F'],
         ...
         * @return array [values, frequencies]
         */
        public static function dataProviderForCumulativeRelativeFrequency(
        ): array
        {
            return [
                [
         ...
         * @return array
         */
        public static function dataProviderForRankingWithoutTies(): array
        {
            return [
                [
                    [0],
         ...
         * @return array
         */
        public static function dataProviderForFractionalRank(): array
        {
            return [
                [
                    [1, 2, 2, 3],
         ...
         * @return array
         */
        public static function dataProviderForStandardCompetitionRanking(
        ): array
        {
            return [
                [
         ...
         * @return array
         */
        public static function dataProviderForModifiedCompetitionRanking(
        ): array
        {
            return [
                [
         ...
         * @return array
         */
        public static function dataProviderForOrdinalRanking(): array
        {
            return [
                [
                    [1, 2, 2, 3],
         ...
         */
        public static function dataProviderForStemAndLeafPlot(): array
        {
            return [
                [
                    [
         ...
         * @param array $expected
         */
        public function testCumulativeRelativeFrequency(
            array $values,
            array $expected
        ) {
            // When
         ...
         * @param array $values
         */
        public function testFractionalRankingDistributionSumOfAllRanks(
            array $values
        ) {
            // Given
            $n = count($values);
            ...
            $this->assertEquals($expectedSumOfAssignedRanks,
                $sumOfAssignedRanks);
        }
         ...
         * @param array $expected
         */
        public function testStandardCompetitionRanking(
            array $values,
            array $expected
        ) {
            // When
        ...
        public function testStemAndLeafPlotPrint()
        {
            ...
            // When
            Distribution::stemAndLeafPlot([1, 2, 3], TRUE);
        }
    }
