<?php
    ...
    class LinearTest extends TestCase {
         ...
         */
        public static function dataProviderForFProbability(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForTProbability(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForLeverages(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForDF(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForGetProjection(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForMeanSquares(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForOutliers(): array
        {
            return [
        ...
        public function testConstructor()
        {
            ...
            $this->assertInstanceOf(Regression::class,
                $regression);
            $this->assertInstanceOf(Linear::class,
                $regression);
        }
         ...
         * @param float $beta1
         */
        public function testTProbability(
            array $points,
            float $beta0,
            float $beta1
        ) {
        ...
        public function testDF(array $points, int $df)
        {
            ...
            // Then
            $this->assertEqualsWithDelta($df, $regression->degreesOfFreedom(),
                .0000001);
        }
