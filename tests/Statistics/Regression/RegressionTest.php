<?php
    ...
    class RegressionTest extends TestCase {
         ...
         */
        public static function dataProviderForR(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForR2(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
         ...
         */
        public static function dataProviderForSumOfSquaresTotal(): array
        {
            return [
                [
                    [
         ...
         */
        public static function dataProviderForYHat(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
                    // m = 1.2209302325581, b = 0.60465116279069
                    [
                        1.82558139534879,
                        3.04651162790689,
                        5.48837209302309,
         ...
         */
        public static function dataProviderForSumOfSquaresRegression(): array
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
                    // y mean = 5; yhat = [1.82558139534879, 3.04651162790689, 5.48837209302309, 6.70930232558119, 7.93023255813929]
                    25.63953488371927,
                    // 10.07693347755574 + 3.81611681990299 + 0.23850730124375 + 2.92171444023726 + 8.58626284477953
                ],
                [
                    [
                        [61, 105],
                    ...
                    // y mean = 150; yhat = [108.1914893617, 115.15957446809, 122.12765957447, 136.06382978723, 136.06382978723, 156.96808510638, 163.93617021277, 170.90425531915, 184.84042553191, 205.74468085106]
                    9128.19148936100534,
                    // 1747.95156179284427 + 1213.85525124456621 + 776.86736079663386 + 194.21684019929783 + 194.21684019929783 + 48.55421004975478 + 194.21684019929783 + 436.98789044821107 + 1213.85525124456621 + 3107.46944318653545
                ],
            ];
        }
        ...
        public static function dataProviderForSumOfSquaresResidual()
        {
            return [
                [
                    [[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]],
                    // yhat = [1.82558139534879, 3.04651162790689, 5.48837209302309, 6.70930232558119, 7.93023255813929]
                    0.36046511627907,
                    // 0.03042184964848 + 0.00216333153055 + 0.23850730124375 + 0.0845051379125 + 0.00486749594379
                ],
                [
                    [
                        [61, 105],
                    ...
                    // yhat = [108.1914893617, 115.15957446809, 122.12765957447, 136.06382978723, 136.06382978723, 156.96808510638, 163.93617021277, 170.90425531915, 184.84042553191, 205.74468085106]
                    1271.80851063820534,
                    // 10.18560434584427 + 23.42971932996621 + 4.52693526483386 + 572.94024445469783 + 258.04662743309783 + 143.23506111355478 + 122.40832956079783 + 118.90278406521107 + 0.02546401086621 + 18.10774105933545
                ],
            ];
        }
         ...
         * @return array [points]
         */
        public static function dataProviderForSumOfSquaresEqualsSumOfSQuaresRegressionPlusSumOfSquaresResidual(
        ): array
        {
            return [
                [[[1, 2], [2, 3], [4, 5], [5, 7], [6, 8]]],
        ...
        public function testSumOfSquareResidual(array $points, float $SSres)
        {
            ...
            // Then
            $this->assertEqualsWithDelta($SSres,
                $regression->sumOfSquaresResidual(), 0.00001);
        }
         ...
         * @param array $points
         */
        public function testSumOfSquaresEqualsSumOfSQuaresRegressionPlusSumOfSquaresResidual(
            array $points
        ) {
            // Given
            $regression = new Linear($points);
