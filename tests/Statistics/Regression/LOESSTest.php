<?php
    ...
    class LOESSTest extends TestCase {
        /**
         ...
         */
        public static function dataProviderForSmoothnessParameterOutOfBoundsException(
        ): array
        {
            return [
                [
         ...
         * @throws       \Exception
         */
        public function testSmoothnessParameterOutOfBoundsException(
            array $points,
            float $α,
            float $λ
        ) {
