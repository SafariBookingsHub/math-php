<?php
    ...
    class RandomVariableTest extends TestCase {
        /**
         * @return array [X, n, moment]
         */
        public static function dataProviderForCentralMoment(): array
        {
            return [
         ...
         */
        public static function dataProviderForPopulationSkewness(): array
        {
            return [
                [
                    [
         ...
         * @return array [X, skewness]
         */
        public static function dataProviderForSampleSkewness(): array
        {
            return [
                [
                    [
         ...
         * @return array [X, skewness]
         */
        public static function dataProviderForSkewnessNan(): array
        {
            return [
                [[-1, -1, -1]],
                [[10, 10, 10]],
         ...
         * @return array [X, skewness]
         */
        public static function dataProviderForAlternativeSkewness(): array
        {
            return [
                [
                    [
         ...
         */
        public static function dataProviderForSkewness(): array
        {
            return [
                // Population skewness
                [
                    ...
                    RandomVariable::POPULATION_SKEWNESS,
                    -0.1081544,
                ],
                [
                    [2, 3, -1, 3, 4, 5, 0, 2],
                ...
                [
                    ...
                    RandomVariable::SAMPLE_SKEWNESS,
                    -0.1098084,
                ],
                [
                    [2, 3, -1, 3, 4, 5, 0, 2],
                ...
                [
                    ...
                    RandomVariable::ALTERNATIVE_SKEWNESS,
                    -0.107612,
                ],
                [
                    [1, 2, 3, 4, 5, 9, 23, 32, 69],
         ...
         * @return array [n, ses]
         */
        public static function dataProviderForSes(): array
        {
            return [
                [5, 0.913],
                [10, 0.687],
         ...
         * @return array [n]
         */
        public static function dataProviderForSesException(): array
        {
            return [
                [-1],
                [0],
         ...
         */
        public static function dataProviderForSampleKurtosis(): array
        {
            return [
                [
                    [
         ...
         * @return array [X, kurtosis]
         */
        public static function dataProviderForPopulationKurtosis(): array
        {
            return [
                [
                    [
         ...
         * @return array [X, skewness]
         */
        public static function dataProviderForPopulationKurtosisNan(): array
        {
            return [
                [[-1, -1, -1, -1]],
                [[1, 1, 1, 1]],
         ...
         * @return array [X, skewness]
         */
        public static function dataProviderForPopulationKurtosisErrorFewerThanFourNumbers(
        ): array
        {
            return [
                [[1]],
         ...
         */
        public static function dataProviderForKurtosis(): array
        {
            return [
                // Population kurtosis
                [
                    ...
                    RandomVariable::POPULATION_KURTOSIS,
                    0.4466489,
                ],
                [
                    [0, 7, 7, 6, 6, 6, 5, 5, 4, 1],
                ...
                [
                    ...
                    RandomVariable::SAMPLE_KURTOSIS,
                    -0.2320107,
                ],
                [
                    [0, 7, 7, 6, 6, 6, 5, 5, 4, 1],
         ...
         * @return array [data]
         */
        public static function dataProviderForPlatykurtic(): array
        {
            return [
                [[2, 2, 4, 6, 8, 10, 10]],
            ];
         ...
         * @return array [data]
         */
        public static function dataProviderForLeptokurtic(): array
        {
            return [
                [[1, 2, 3, 4, 5, 9, 23, 32, 69]],
            ];
         ...
         * @return array [data]
         */
        public static function dataProviderForMesokurtic(): array
        {
            return [
                [[4, 5, 5, 5, 5, 6]],
            ];
         ...
         * @return array [n, sek]
         */
        public static function dataProviderForSek(): array
        {
            return [
                [5, 2],
                [10, 1.334],
         ...
         * @return array [n]
         */
        public static function dataProviderForSekException(): array
        {
            return [
                [-1],
                [0],
         ...
         * @return array [X, sem]
         */
        public static function dataProviderForStandardErrorOfTheMean(): array
        {
            return [
                [[1, 2, 3, 4, 5, 5, 6, 7], 0.7180703308172536],
                [[34, 6, 23, 12, 25, 64, 32, 75], 8.509317372319423],
                [
                    [1.5, 1.3, 2.532, 0.43, 0.042, 5.9, 0.9942, 1.549],
                    0.645903079859,
                ],
                [
                    [
         ...
         */
        public static function dataProviderForConfidenceInterval(): array
        {
            return [
                [
                    90,
         ...
         */
        public static function dataProviderForSumOfSquaresDeviations(): array
        {
            return [
        ...
        public function testPopulationSkewness(array $X, float $expected)
        {
            ...
            // Then
            $this->assertEqualsWithDelta($expected, $populationSkewness,
                0.000001);
        }
         ...
         * @throws       \Exception
         */
        public function testSkewnessDefaultTypeIsSampleSkewness(
            array $X,
            float $expected
        ) {
            // When
         ...
         * @throws       \Exception
         */
        public function testSkewnessDefaultTypeIsPopulationKurtosis(
            array $X,
            float $expected
        ) {
            // When
         ...
         * @throws       \Exception
         */
        public function testSumOfSquaresDeviations(
            array $numbers,
            float $expected
        ) {
            // When
