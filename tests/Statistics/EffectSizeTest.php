<?php
    ...
    class EffectSizeTest extends TestCase {
        /**
         * @return array [SSt, SST, expected]
         */
        public static function dataProviderForEtaSquared(): array
        {
            return [
         ...
         */
        public static function dataProviderForPartialEtaSquared(): array
        {
            return [
         ...
         */
        public static function dataProviderForOmegaSquared(): array
        {
            return [
                // Test data: http://www.uccs.edu/lbecker/glm_effectsize.html
         ...
         */
        public static function dataProviderForCohensF(): array
        {
            return [
         ...
         */
        public static function dataProviderForCohensQ(): array
        {
            return [
                [0.1, 0.1, 0],
                [0.5, 0.5, 0],
         ...
         */
        public static function dataProviderForCohensD(): array
        {
            return [
         ...
         */
        public static function dataProviderForHedgesG(): array
        {
            return [
         ...
         */
        public static function dataProviderForGlassDelta(): array
        {
            return [
         ...
         * @param float $expected
         */
        public function testPartialEtaSquared(
            float $SSt,
            float $SSE,
            float $expected
        ) {
         ...
         * @param float $expected
         */
        public function testOmegaSquared(
            float $SSt,
            int $dft,
            float $SST,
            float $MSE,
         ...
         * @param float $expected
         */
        public function testCohensF(
            float $measure_of_variance_explained,
            float $expected
        ) {
            // When
         ...
         * @param float $expected
         */
        public function testGlassDelta(
            float $μ₁,
            float $μ₂,
            float $s₂,
            float $expected
