<?php
    ...
    class SignificanceTest extends TestCase {
         ...
         */
        public static function dataProviderForZScore(): array
        {
            return [
                [1, 1, 1, 0],
                [1, 1, 2, 1],
         ...
         * @return array [μ, σ, M, z]
         */
        public static function dataProviderForZScoreRaw(): array
        {
            return [
                [1, 1, 1, 0],
                [1, 1, 2, 1],
         ...
         */
        public static function dataProviderForSem(): array
        {
            return [
                [5, 100, 0.5],
         ...
         */
        public static function dataProviderForZTestOneSample(): array
        {
            return [
                [
                    96,
                ...
                [
                    ...
                    19.2,
                    6,
                    ['z' => 1.88562, 'p1' => 0.02938, 'p2' => 0.0593],
                ],
                [
                    22.875,
                    35,
         ...
         */
        public static function dataProviderForZTestTwoSample(): array
        {
            return [
                [
                    28,
                    ...
                    9.5,
                    0,
                    ['z' => -2.36868418147285, 'p1' => 0.00893, 'p2' => 0.0179],
                ],
                [
                    9.78,
                    15.10,
                    ...
                    4.28,
                    0,
                    ['z' => -27.83, 'p1' => 0.0, 'p2' => 0.0],
                ],
                // Test data: http://www.stat.ucla.edu/~cochran/stat10/winter/lectures/lect21.html
                [
                    150.0648965,
                    126.7361145,
                    68,
                    ...
                    199.3031358,
                    0,
                    ['z' => 0.761, 'p1' => 0.22335, 'p2' => 0.4467],
                ],
                // Github issue 175 test data
                [
                    3100,
                    2750,
                    75,
         ...
         */
        public static function dataProviderForTScore(): array
        {
            return [
         ...
         */
        public static function dataProviderForTTestOneSample(): array
        {
            return [
                [
         ...
         */
        public static function dataProviderForTTestOneSampleFromSummaryData(
        ): array
        {
            return [
                [
         ...
         */
        public static function dataProviderFortTestTwoSampleDataSet(): array
        {
            return [
                [
                    [
         ...
         */
        public static function dataProviderForTTestTwoSampleFromSummaryData(
        ): array
        {
            return [
         ...
         */
        public static function dataProviderForChiSquaredTest(): array
        {
            return [
         ...
         */
        public function testZTestOneSample(
            float $Hₐ,
            int $n,
            float $H₀,
            float $σ,
         ...
         * @param array $expected
         */
        public function testZTestTwoSample(
            float $μ₁,
            float $μ₂,
            int $n₁,
            int $n₂,
            ...
            // When
            $zTest = Significance::zTestTwoSample($μ₁, $μ₂, $n₁, $n₂, $σ₁, $σ₂,
                $Δ);
        ...
        public function testTTestWithOneSampleData(
            ...
            $this->assertEqualsWithDelta($expected['df'], $tTest['df'],
                0.00001);
            $this->assertEqualsWithDelta($expected['p1'], $tTest['p1'], 0.0001);
            $this->assertEqualsWithDelta($expected['p2'], $tTest['p2'],
                0.00001);
            $this->assertEqualsWithDelta($expected['mean'], $tTest['mean'],
                0.00001);
            $this->assertEqualsWithDelta($expected['sd'], $tTest['sd'],
                0.00001);
        }
         ...
         * @param array $expected
         */
        public function testTTestOneSampleFromSummaryData(
            array $a,
            float $H₀,
            array $expected
        ) {
            ...
            // When
            $tTest = Significance::tTestOneSampleFromSummaryData($Hₐ, $s, $n,
                $H₀);
         ...
         * @param array $expected
         */
        public function testTTestOneSampleFromSummaryData2(
            float $Hₐ,
            float $s,
            int $n,
            float $H₀,
         ...
         * @param array $expected
         */
        public function testtTestTwoSample(
            array $x₁,
            array $x₂,
            float $μ₁,
            float $μ₂,
         ...
         * @param array $expected
         */
        public function testtTestTwoSampleFromSummaryData(
            array $x₁,
            array $x₂,
            float $μ₁,
            float $μ₂,
            ...
            // When
            $tTest = Significance::tTestTwoSampleFromSummaryData($μ₁, $μ₂, $n₁,
                $n₂, $σ₁, $σ₂);
         ...
         * @param array $expected
         */
        public function testTTestTwoSampleFromSummaryDataRegression(
            float $μ₁,
            float $μ₂,
            int $n₁,
            int $n₂,
         ...
         * @throws       \Exception
         */
        public function testChiSquaredTest(
            array $observed,
            array $expected,
            float $χ²,
            float $p
