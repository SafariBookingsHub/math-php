    ...
    class CircularTest extends TestCase {
        ...
        public static function dataProviderForMean(): array
        {
            ...
            return [
                ...
                [[0, 0, 90], .5226276],
                [
                    [1.4 * $π, 1.7 * $π, 1.75 * $π, 2.54 * $π, 4.32 * $π],
                    -0.4242655,
                ],
                [[5, 60, 340], -1.423654],
         ...
         */
        public static function dataProviderForResultantLength(): array
        {
            $π = M_PI;
         ...
         * @return array [angles, length]
         */
        public static function dataProviderForMeanResultantLength(): array
        {
            $π = M_PI;
