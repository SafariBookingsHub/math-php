<?php
    ...
    class SVDTest extends TestCase {
         ...
         * @return array
         */
        public static function dataProviderForSVD(): array
        {
            return [
                [
                    [
         ...
         * @return array
         */
        public static function dataProviderForLesserRankSVD(): array
        {
            return [
                [
                    [
        ...
        public function testSVD(array $A, array $expected)
        {
            ...
            $this->assertEqualsWithDelta($expected_S->getMatrix(),
                $S->getMatrix(), 0.00001);
        }
        ...
        public function testSVDProperties(array $A)
        {
            ...
            foreach ($D->getVector() as $key => $singularValue)
            {
                ...
                {
                    $array_filter[$key] = $singularValue;
                }
            }
        ...
        public function testLesserRankSVDProperties(array $A)
        {
            ...
            $this->assertEqualsWithDelta($svd->D->getVector(),
                $svd->getS()->getDiagonalElements(), 0.00001, '');
        }
