<?php
     ...
     *    - |S| = n, then |P(S)| = 2ⁿ
     */
    class SetAxiomsTest extends TestCase {
            ...
            return [
                ...
                [
                    new Set([
                        ...
                        '4',
                        5,
                        new Set([3, 4, 5, new Set([1, 2])]),
                    ]),
                ],
            ];
        }

        public static function dataProviderForTwoSets(): array
        {
            return [
                [
                    new Set([]),
        ...
        public static function dataProviderForThreeSets(): array
        {
            return [
                [
                    new Set([]),
        ...
        public static function dataProviderForTwoSetsDifferent(): array
        {
            return [
                [
                    new Set([1]),
         ...
         * @param Set $B
         */
        public function testADiffBDifferentFromBDiffAWhenNotEqual(
            Set $A,
            Set $B
        ) {
            // Given
         ...
         * @param Set $B
         */
        public function testASymmetricDifferentBEqualsUnionADiffBAndBDiffA(
            Set $A,
            Set $B
        ) {
            // Given
         ...
         * @param Set $C
         */
        public function testACrossUnionBCEqualsACrossBUnionACrossC(
            Set $A,
            Set $B,
            Set $C
        ) {
            ...
            $⟮A×B⟯∪⟮A×C⟯ = $A->cartesianProduct($B)
                ->union($A->cartesianProduct($C));
         ...
         * @param Set $C
         */
        public function testAUnionBCrossCEqualsUnsionOfACRossCAndBCrossC(
            Set $A,
            Set $B,
            Set $C
        ) {
            ...
            $⟮A×C⟯∪⟮B×C⟯ = $A->cartesianProduct($C)
                ->union($B->cartesianProduct($C));
        ...
        public function testCardinalityOfPowerSet(Set $A)
        {
            ...
            // Then
            $this->assertEquals(2 ** $n, count($P⟮S⟯));
            $this->assertEquals(2 ** $n, count($P⟮S⟯->asArray()));
        }
    }
