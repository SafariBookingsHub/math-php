<?php
    ...
    class CombinatoricsTest extends TestCase {
         ...
         */
        public static function dataProviderForDoubleFactorial(): array
        {
            return [
                [0, 1],
                [1, 1],
         ...
         */
        public static function dataProviderForRisingFactorial(): array
        {
            return [
                [5, 0, 1],
                [5, 1, 5],
         ...
         */
        public static function dataProviderForFallingFactorial(): array
        {
            return [
                [5, 0, 1],
                [5, 1, 5],
         ...
         * @return array [n, ！n]
         */
        public static function dataProviderForSubfactorial(): array
        {
            return [
                [0, 1],
                [1, 0],
         ...
         */
        public static function dataProviderForFactorialPermutations(): array
        {
            return [
                [1, 1],
                [2, 2],
         ...
         */
        public static function dataProviderForPermutationsChooseK(): array
        {
            return [
                [10, 0, 1],
                [10, 1, 10],
         ...
         */
        public static function dataProviderForCombinationsWithLargeFloatingPointOverflowResult(
        ): array
        {
            return [
         ...
         * @return array [n, r, combinations]
         */
        public static function dataProviderForCombinationsWithRepetition(
        ): array
        {
            return [
                [10, 0, 1],
         ...
         * @return array [n, r, combinations, ε]
         */
        public static function dataProviderForCombinationsWithRepetitionWithLargeFloatingPointOverflowResult(
        ): array
        {
            return [
         ...
         * @return array [n, ！n]
         */
        public static function dataProviderForCentralBinomialCoefficient(
        ): array
        {
            return [
                [0, 1],
         ...
         * @return array [n, ！n]
         */
        public static function dataProviderForCatalanNumber(): array
        {
            return [
                [0, 1],
                [1, 1],
         ...
         */
        public static function dataProviderForMultinomialTheorem(): array
        {
            return [
                [[2, 0, 1], 3],
                [[1, 1, 1], 6],
         ...
         */
        public static function dataProviderForLahNumber(): array
        {
            return [
                [1, 1, 1],
                [2, 1, 2],
         ...
         * @return array [n, k]
         */
        public static function dataProviderForLahNumberExceptionNOrKLessThanOne(
        ): array
        {
            return [
                [-1, 2],
         ...
         * @throws       \Exception
         */
        public function testCombinationsWithLargeFloatingPointOverflowResult(
            int $n,
            int $r,
            float $expected,
            float $ε
         ...
         * @throws       \Exception
         */
        public function testCombinationsWithRepetition(
            int $n,
            int $r,
            float $expected
        ) {
         ...
         * @throws       \Exception
         */
        public function testCombinationsWithRepetitionWithLargeFloatingPointOverflowResult(
            int $n,
            int $r,
            float $expected,
            float $ε
