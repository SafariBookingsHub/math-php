<?php
    ...
    class StandardNormalTableTest extends TestCase {
        public static function dataProviderForZScores(): array
        {
            return [
                [0, 0.5000],
                [0.01, 0.5040],
        ...
        public static function dataProviderForZScoresForConfidenceInterval(
        ): array
        {
            return [
                [50, 0.67449],
