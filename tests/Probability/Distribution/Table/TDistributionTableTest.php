<?php
    ...
    class TDistributionTableTest extends TestCase {
        public static function dataProviderForOneSidedCL(): array
        {
            return [
                [1, 0, 0],
                [1, 75, 1.000],
        ...
        public static function dataProviderForTwoSidedCL(): array
        {
            return [
                [1, 0, 0],
                [1, 50, 1.000],
        ...
        public static function dataProviderForOneSidedAlpha(): array
        {
            return [
                [1, '0.50', 0],
                [1, 0.25, 1.000],
        ...
        public static function dataProviderForTwoSidedAlpha(): array
        {
            return [
                [1, '1.00', 0],
                [1, '0.50', 1.000],
        ...
        public function testGetOneSidedTValueFromConfidenceLevel(
            ...
            // When
            $value = TDistribution::getOneSidedTValueFromConfidenceLevel($ν,
                $cl);
        ...
        public function testGetTwoSidedTValueFromConfidenceLevel(
            ...
            // When
            $value = TDistribution::getTwoSidedTValueFromConfidenceLevel($ν,
                $cl);
