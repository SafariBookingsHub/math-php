<?php
     ...
     *   - L(n,n) = 1
     */
    class CombinatoricsAxiomsTest extends TestCase {
        /**
         * @return array [n, k]
         */
        public static function dataProivderForLahNumbers(): array
        {
            return [
                [1, 1],
                [5, 1],
         ...
         * @return array [n]
         */
        public static function dataProivderForLahNumberIdentities(): array
        {
            return [
                [1],
                [2],
         ...
         * @return array [n]
         */
        public static function dataProivderForLahNumberIdentitiesGreaterThanOne(
        ): array
        {
            return [
                [2],
         ...
         * @throws       \Exception
         */
        public function testRisingFactorialAsLahNumberAndFallingFactorial(
            int $x,
            int $n
        ) {
         ...
         * @throws       \Exception
         */
        public function testFallingFactorialAsLahNumberAndRisingFactorial(
            int $x,
            int $n
        ) {
