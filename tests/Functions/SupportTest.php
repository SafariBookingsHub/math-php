<?php
    ...
    class SupportTest extends TestCase {
        ...
        public static function dataProviderForNotZero(): array
        {
            return [
                [1],
                [1.0],
         ...
         * @throws       \Exception
         */
        public function testCheckLimitsLowerLimitException(
            array $limits,
            array $params
        ) {
            // Then
         ...
         * @throws       \Exception
         */
        public function testCheckLimitsUpperLimitException(
            array $limits,
            array $params
        ) {
            // Then
         ...
         * @throws       \Exception
         */
        public function testCheckLimitsUndefinedParameterException(
            array $limits,
            array $params
        ) {
            // Then
