<?php
    ...
    class ArbitraryIntegerTest extends TestCase {
        /**
         * @return array (numberAsString, stringRepresentation)
         */
        public static function dataProviderForIntToString(): array
        {
            return [
                [-1, '-1'],
                [0, '0'],
         ...
         * @return array (numberAsString, stringRepresentation)
         */
        public static function dataProviderForStringIntToString(): array
        {
            return [
                ['-1', '-1'],
                ['0', '0'],
         ...
         * @return array (numberAsString, stringRepresentation)
         */
        public static function dataProviderForBinaryToString(): array
        {
            return [
                ['0b0', '0'],
                ['0b1', '1'],
                ...
                ['0b1101', '13'],
                [
                    '0b10001111110000110000011101111111001101110111',
                    '9879237948279',
                ],
                ['-0b1', '-1'],
                ['-0b10', '-2'],
         ...
         * @return array (numberAsString, stringRepresentation)
         */
        public static function dataProviderForHexToString(): array
        {
            return [
                ['0x0', '0'],
                ['0x1', '1'],
         ...
         * @return array (numberAsString, stringRepresentation)
         */
        public static function dataProviderForOctalToString(): array
        {
            return [
                ['00', '0'],
                ['01', '1'],
        ...
        public static function dataProviderForIntToInt(): array
        {
            return [
                [0],
                [1],
        ...
        public static function dataProviderForStringToFloat(): array
        {
            return [
                ['0', 0.0],
                ['1', 1.0],
        ...
        public static function dataProviderForPositiveInt(): array
        {
            return [
                [0],
                [1],
        ...
        public static function dataProviderForNegativeInt(): array
        {
            return [
                [-1],
                [-2],
        ...
        public static function dataProviderForTestAddition(): array
        {
            return [
                ['1', '0', '1'],
                ['0', '1', '1'],
                ...
                [
                    '983759729375923795837849',
                    '98734957979279759843798',
                    '1082494687355203555681647',
                ],
                [
                    '983759729375923795837849',
                    '-98734957979279759843798',
                    '885024771396644035994051',
                ],
            ];
        }

        public static function dataProviderForTestSubtract(): array
        {
            return [
                ['1', '0', '1'],
                ['1', '1', '0'],
        ...
        public static function dataProviderForTestMultiplication(): array
        {
            return [
                ['1', '1', '1'],
                ['-1', '1', '-1'],
                ...
                [
                    '983759729375923795837849',
                    '10000000000',
                    '9837597293759237958378490000000000',
                ],
            ];
        }

        public static function dataProviderForIntDivSmallDivisor(): array
        {
            return [
                ['5', 5, '1', '0'],
                ['10', 5, '2', '0'],
        ...
        public static function dataProviderForIntDivLargeDivisor(): array
        {
            return [
        ...
        public static function dataProviderForPowRational(): array
        {
            return [
        ...
        public static function dataProviderForFact(): array
        {
            return [
                [-1, '1'],
                [0, '1'],
         ...
         */
        public static function dataProviderForLeftShift(): array
        {
            return [
                ['0', 0, '0'],
                ['0', 1, '0'],
        ...
        public static function dataProviderForGreaterThan(): array
        {
            return [
                ['0', '-1'],
                ['1', '0'],
        ...
        public static function dataProviderForNotGreaterThan(): array
        {
            return [
                ['-1', '0'],
                ['0', '1'],
         ...
         * @throws       \Exception
         */
        public function testIntDivAndModSmallDivisor(
            string $dividend,
            int $divisor,
         ...
         * @throws       \Exception
         */
        public function testFullIntDivSmallDivisor(
            string $dividend,
            int $divisor,
            string $expectedQuotient,
            string $expectedMod
         ...
         * @throws       \Exception
         */
        public function testIntDivLargeDivisor(
            string $dividend,
            string $divisor,
            string $expectedQuotient,
            string $expectedMod
         ...
         * @throws       \Exception
         */
        public function testFullIntDivLargeDivisor(
            string $dividend,
            string $divisor,
            string $expectedQuotient,
            string $expectedMod
